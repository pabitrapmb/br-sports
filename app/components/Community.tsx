  ...
  return (
    <section id="community" className="relative py-24 px-6 bg-[#f0fdf4] overflow-hidden">
      ...
      <div className="relative z-10 max-w-5xl mx-auto">
        ...
        <div className="w-16 h-1 rounded-full mx-auto mb-14"
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="flex justify-center lg:justify-end">
            <div
              className="relative rounded-3xl p-[2px] w-full max-w-[300px]"
              style={{ background: "linear-gradient(135deg, #25D366, #128C7E, #25D366)" }}
            >
              <div className="rounded-[22px] bg-white p-8 flex flex-col items-center text-center">
                ...
                {/* QR code */}
                <div className="w-44 h-44 rounded-2xl bg-white p-2 mb-5
                ...
                <p className="text-slate-800 font-bold text-sm mb-1">Scan to Join</p>
                <p className="text-slate-400 text-xs tracking-wider uppercase mb-6">
                ...
                <div className="flex items-center gap-3 w-full mb-6">
                  ...
                  <span className="text-slate-400 text-[10px] uppercase tracking-widest">or</span>
                  <div className="flex-1 h-px bg-slate-200" />
                </div>
